...
hero:
  name: "Studenti Marconi"

features:
  - title: Social
    link: /social.md
    details: Tutte le pagine social, i gruppi e i contatti di StudentiMarconi.
    icon: |
  ...
  - title: Progetti
    link: /progetti/
    details: Tutti i progetti organizzati dai rappresentanti e dagli studenti del Marconi.
    icon: |
  ...
  #- title: Wiki
  #  link: /wiki
  #  details: Appunti e guide scolastiche scritte dagli studenti, per gli studenti.
  #  icon: |
  ...
  #- title: MarconiCraft
  #  link: /marconicraft
  #  details: Come scaricare Minecraft ed entrare nel Server del Marconi.
  #  icon: |
  ...
  #  details: Mappa 3D live del mondo di MarconiCraft.
  #  icon: |
